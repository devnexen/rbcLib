...
#define SERVO_CHECK_END		ID ++; \
			}
	

#define RBC_MOVE_CHECK(ID, idx, idA, idB)	unsigned char commandMove[70] = { 0xFF, (0xE0 + ID), 0x64, (0x00 + idx), (0x00 + idx), 0x04, 0xFF, 0x60, idA, idB, 0xFF, 0xC1, 0x10, 0x51, 0xFF, 0xC2, \
